...
export interface SearchBarAdvancePaymentProps {
	...
	sortValue?: SortValue;
	placeholder?: string;
	activeTab?: 0 | 1; // 0 = czynsz, 1 = saldo
}

const FILTER_OPTIONS: { value: FilterStatus; label: string }[] = [
	{ value: "all", label: "Wszystkie" },
	{ value: "withBalance", label: "Z saldem" },
	{ value: "withoutBalance", label: "Bez salda" },
...
const SearchBarAdvancePayment: React.FC<SearchBarAdvancePaymentProps> = ({
	onAddClick,
	onSearch,
	onFilterChange,
	onSortChange,
...
export default SearchBarAdvancePayment; 