...
// --- TYPES ---
export type FilterStatus = "all" | "currentYear" | "upcoming" | "past" | "withFile" | "withoutFile";
export type SortValue = "az" | "za" | "yearAsc" | "yearDesc" | "datesAsc" | "datesDesc";

// --- PROPS ---
export interface SearchBarWasteProps {
	onAddClick?: () => void;
...
const FILTER_OPTIONS: { value: FilterStatus; label: string }[] = [
	...
	{ value: "withFile", label: "Z plikiem" },
	{ value: "withoutFile", label: "Bez pliku" },
];

const SORT_OPTIONS: { value: SortValue; label: string }[] = [
	{ value: "az", label: "Sortuj A-Z" },
	{ value: "za", label: "Sortuj Z-A" },
	{ value: "yearAsc", label: "Rok rosnąco" },
	{ value: "yearDesc", label: "Rok malejąco" },
	{ value: "datesAsc", label: "Liczba terminów rosnąco" },
	{ value: "datesDesc", label: "Liczba terminów malejąco" },
];

const SearchBarWaste: React.FC<SearchBarWasteProps> = ({
	onAddClick,
	onSearch,
	onFilterChange,
	onSortChange,
