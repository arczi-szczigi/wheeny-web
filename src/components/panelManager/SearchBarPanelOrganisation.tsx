...
export type SortValue = "az" | "za" | "newest" | "oldest" | "mostEstates" | "leastEstates";
...
const FILTER_OPTIONS: { value: FilterStatus; label: string }[] = [
	...
	{ value: "unconfirmed", label: "Niepotwierdzone" },
];
...
const SORT_OPTIONS: { value: SortValue; label: string }[] = [
	...
	{ value: "mostEstates", label: "Najwięcej osiedli" },
	{ value: "leastEstates", label: "Najmniej osiedli" },
];
