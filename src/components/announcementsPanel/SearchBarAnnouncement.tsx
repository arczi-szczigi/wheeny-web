...
// --- TYPES ---
export type FilterStatus = "all" | "recent" | "old" | "thisMonth" | "thisWeek";
export type SortValue = "az" | "za" | "dateNewest" | "dateOldest";

// --- PROPS ---
export interface SearchBarAnnouncementProps {
	onAddClick?: () => void;
...
const FILTER_OPTIONS: { value: FilterStatus; label: string }[] = [
	...
	{ value: "recent", label: "Ostatnie 7 dni" },
	{ value: "thisMonth", label: "Ten miesiąc" },
	{ value: "thisWeek", label: "Ten tydzień" },
	{ value: "old", label: "Starsze niż miesiąc" },
];

const SORT_OPTIONS: { value: SortValue; label: string }[] = [
	{ value: "az", label: "Sortuj A-Z" },
	{ value: "za", label: "Sortuj Z-A" },
	{ value: "dateNewest", label: "Data (najnowsze)" },
	{ value: "dateOldest", label: "Data (najstarsze)" },
];

const SearchBarAnnouncement: React.FC<SearchBarAnnouncementProps> = ({
	onAddClick,
	onSearch,
	onFilterChange,
	onSortChange,
...
export default SearchBarAnnouncement; 